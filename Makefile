...
# Source
HEADERS=src/mbb/image.h src/mbb/images_pyramid.h src/mbb/log.h src/mbb/math.h src/mbb/mbb.h src/mbb/prerequisites.h
SOURCES=src/main.c src/mbb/image.c src/mbb/images_pyramid.c src/mbb/log.c src/mbb/math.c src/mbb/mbb.c
